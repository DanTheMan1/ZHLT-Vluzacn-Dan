...
#define HACK_VERSIONSTRING "VL33" //--vluzacn
...
#endif
#if !defined (VERSION_32BIT) && !defined (VERSION_64BIT) && !defined (VERSION_OTHER) //--vluzacn
#error "You must define one of these in the settings of each project: VERSION_32BIT, VERSION_64BIT, VERSION_OTHER. The most likely cause is that you didn't load the project from the sln file."
#endif

#ifdef VERSION_32BIT
#define PLATFORM_VERSIONSTRING "32-bit"
#define CAN_CALC_EXTENT
#endif
#ifdef VERSION_64BIT
#define PLATFORM_VERSIONSTRING "64-bit"
//#define CAN_CALC_EXTENT // if this flag is set, proper code must be implemented in GetFaceExtents
#endif
#ifdef VERSION_OTHER
...
//#define HLCSG_WADCFG // rewritten into HLCSG_WADCFG_NEW due to too many flaws.
	#ifndef HLCSG_WADCFG
