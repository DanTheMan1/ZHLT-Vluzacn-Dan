...
#endif
{
	...
	for (int k = 0; k < 3; k++)
	{
		leaf_p->mins[k] = (short)max (-32767, min ((int)mins[k], 32767));
		leaf_p->maxs[k] = (short)max (-32767, min ((int)maxs[k], 32767));
	}
#else
	...
	for (int k = 0; k < 3; k++)
	{
		leaf_p->mins[k] = (short)max (-32767, min ((int)portalleaf->mins[k], 32767));
		leaf_p->maxs[k] = (short)max (-32767, min ((int)portalleaf->maxs[k], 32767));
	}
#else
	...
	for (int k = 0; k < 3; k++)
	{
		leaf_p->mins[k] = (short)max (-32767, min ((int)node->mins[k], 32767));
		leaf_p->maxs[k] = (short)max (-32767, min ((int)node->maxs[k], 32767));
	}
#else
...
#endif
{
	...
	for (int k = 0; k < 3; k++)
	{
		n->mins[k] = (short)max (-32767, min ((int)mins[k], 32767));
		n->maxs[k] = (short)max (-32767, min ((int)maxs[k], 32767));
	}
#else
	...
	for (int k = 0; k < 3; k++)
	{
		n->mins[k] = (short)max (-32767, min ((int)node->mins[k], 32767));
		n->maxs[k] = (short)max (-32767, min ((int)node->maxs[k], 32767));
	}
#else
